...
var baseScatterMethods = {
    ...
    _animateComplete: function() {
        var that = this;
        var animationSettings = { duration: that._defaultDuration };
    ...
    _patchMarginOptions: function(options) {
        ...
        var maxSize = [styles.normal, styles.hover, styles.selection]
