...
var RecurrenceEditor = Editor.inherit({
    ...
    _renderRepeatOnWeekEditor: function() {
        ...
        for(var i = 0; i < 7; i++) {
            ...
            var day = this._createComponent($day, CheckBox, {
                text: checkBoxText,
    ...
    _renderRepeatOnYearEditor: function() {
        ...
        var months = [];
        var monthsNames = dateLocalization.getMonthNames("wide");
