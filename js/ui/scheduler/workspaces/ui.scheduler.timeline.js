...
var SchedulerTimeline = SchedulerWorkSpace.inherit({
    ...
    _setTableSizes: function() {
        ...
        var $groupCells = this._$sidebarTable
            .find("tr");
    ...
    _getWorkSpaceMinHeight: function() {
        ...
        var workspaceContainerHeight = this.$element().outerHeight(true) - this.getHeaderPanelHeight() - 2 * DATE_TABLE_CELL_BORDER - 1;
